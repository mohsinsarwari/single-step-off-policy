...
parser.add_argument('--loss_stride', type=float, default=2) # number of simulation steps before adding cost to loss again
...
parser.add_argument('--a1_controller_weights', type=list, default=[4, 4, 20, 4, 20])
parser.add_argument('--a1_warm_up_time', type=float, default=1)
parser.add_argument('--a1_warm_up_vel', type=list, default=[0.3, 0.6])
...
parser.add_argument('--traj_theta_range', type=list, default=[-0.2, 0.2]) #theta range for generated trajectories
...
parser.add_argument('--save_every', type=float, default=20) #save model every # iterations
...
if params["env"] == "car":
    ...
    env = A1GymEnv(total_time=params["horizon"], dt=0.001)
